 ...
 * @param userId  userId return from Google, state set in the App
 * @param userName  userName set by user input
 * @param score score of current game
 * @param end   whether game finished or not
 * @param saved whether current record being saved or not
 * @param setSaved  function for setting the save state
 * @returns {JSX.Element}
 * @constructor
 */
function RecordList({userId, userName, score, end, saved, setSaved}) {
    ...
    /**
     * post new record to server and save to DB
     */
    function saveRecord() {
        // SECOND: save record
    ...
    /**
     * delete record related to this record id
     * @param id record id auto generated by DB
     */
    ...
    /**
     * get request, response is a list of all records within size of current page
     */
    ...
    /**
     * get request, response is a list of records related to userId within size of current page
     */
...
/**
 * single record is a row in the table, td is short for table data
 * @param record  well constructed record object
 * @returns {JSX.Element}
 * @constructor
 */
